...
<script>
import ClassifyJson from "./default_single.json";
...
export default {
  mounted() {
    ...
    window.viewer = viewer = new Cesium.Viewer("cesiumContainer", viewerOption);
    //去除版权信息
  ...
  methods: {
    initModel() {
      let tilesetModel = new Cesium.Cesium3DTileset({
        url: `http://10.11.0.87:8088/home/mapData/baoli3dtile/tileset.json`,
      });
