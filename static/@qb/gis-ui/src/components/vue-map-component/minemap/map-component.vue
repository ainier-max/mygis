<template>
<!--官方文档：http://www.minedata.cn/api/demo/js-api/zh/edit/base/edit-control-->
  <div>
    <div  :id="id" ref="mapComponent" style="position: absolute; top:0; bottom:0; right:0; left:0;">
...
<script>
  export default {
    ...
    methods: {
      ...
      addPolygonByGeojson(areaBoundaryPoints){
