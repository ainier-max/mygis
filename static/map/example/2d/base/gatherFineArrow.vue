<template>
  <div>
    ...
    ></plot-component>
    <el-button type="primary" @click='gather' style='z-index:1000;position:absolute;top:50px;left:50px'>采集直线
    </el-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    gather() {
      this.$refs.plotRef.gatherFineArrow(this.gatherIconOption,this.gatherCallback);
    },
    gatherCallback(fineArrowLayer) {
      console.log("细直线采集的坐标信息为：",fineArrowLayer.gatherPosition);
    }
  },
  mounted: function () {
