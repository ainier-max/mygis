<template>
  <div>
    ...
    <el-button type="primary" @click='getCirclePointTest();' style='z-index:1000;position:absolute;top:100px;left:50px'>
      获取圆中心点
    </el-button>
    <el-button type="primary" @click='getRectPointTest();' style='z-index:1000;position:absolute;top:150px;left:50px'>
      获取矩形中心点
    </el-button>
    <el-button type="primary" @click='getPolygonPointTest();'
               style='z-index:1000;position:absolute;top:200px;left:50px'>获取多边形中心点
    </el-button>
