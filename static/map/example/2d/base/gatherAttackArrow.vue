<template>
  <div>
    ...
    ></plot-component>
    <el-button type="primary" @click='gather' style='z-index:1000;position:absolute;top:50px;left:50px'>采集进攻方向
    </el-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    gather() {
      this.$refs.plotRef.gatherAttackArrow(this.gatherIconOption,this.gatherCallback);
    },
    gatherCallback(attackArrowLayer) {
      console.log("采集的坐标信息为：",attackArrowLayer.gatherPosition);
    }
  },
  mounted: function () {
