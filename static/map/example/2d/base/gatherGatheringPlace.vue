<template>
  <div>
    ...
    ></plot-component>
    <el-button type="primary" @click='gather' style='z-index:1000;position:absolute;top:50px;left:50px'>聚集地
    </el-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    gather() {
      this.$refs.plotRef.gatherGatheringPlace(this.gatherIconOption,this.gatherCallback);
    },
