<template>
  <div>
    ...
    ></plot-component>
    <el-button type="primary" @click='gather' style='z-index:1000;position:absolute;top:50px;left:50px'>采集进攻方向(燕尾)
    </el-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    gather() {
      this.$refs.plotRef.gatherTailedAttackArrow(this.gatherIconOption,this.gatherCallback);
    },
    gatherCallback(tailedAttackArrow) {
      console.log("采集的坐标信息为：",tailedAttackArrow.gatherPosition);
    }
  },
  mounted: function () {
