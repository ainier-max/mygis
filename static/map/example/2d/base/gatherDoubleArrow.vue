<template>
  <div>
    ...
    ></plot-component>
    <el-button type="primary" @click='gather' style='z-index:1000;position:absolute;top:50px;left:50px'>采集钳击箭头
    </el-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    gather() {
      this.$refs.plotRef.gatherDoubleArrow(this.gatherIconOption,this.gatherCallback);
    },
