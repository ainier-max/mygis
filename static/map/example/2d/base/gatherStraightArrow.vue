<template>
  <div>
    ...
    ></plot-component>
    <el-button type="primary" @click='gather' style='z-index:1000;position:absolute;top:50px;left:50px'>采集细直线
    </el-button>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    gather() {
      this.$refs.plotRef.gatherStraightArrow(this.gatherIconOption,this.gatherCallback);
    },
    gatherCallback(straightArrowLayer) {
      console.log("细直线采集的坐标信息为：",straightArrowLayer.gatherPosition);
    }
  },
  mounted: function () {
