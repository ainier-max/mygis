<template>
  <div>
    ...
    <el-button type="primary" @click='addRectTest();' style='z-index:1000;position:absolute;top:50px;left:60px'>先画出矩形
    </el-button>
    ...
    <el-input type="textarea" :rows="1"
              id="relation" placeholder="判断点与矩形的关系"
    ...
    export default {
        ...
        methods: {
            ...
            markerReceiver(markerObj) {
                ...
                var judgeFlag = this.$refs.api.judgeRectByXY(lat, lng, window.rect);
                document.getElementById("relation").value = "点与矩形关系:" + judgeFlag;
            },
            addRectTest() {
                var rectJson = {};
                //每个数组相邻必须有个x或y值相同
                ...
                console.log("window.rect:", window.rect);
            }
        },
        mounted: function () {
