    ...
    module.exports = {
        ...
        methods: {
            ...
            addEventPolygonClick(obj) {
                this.map.onLayerEvent("click", obj, this.polygonClickEventCallBack,"polygonClickName");
            },
            //区域点击回调方法
            ...
            addBreakPoint() {
                ...
                this.map.onMapEvent("click", this.mapEventCallBack,"gatherName123");
            },
            //地图点击回调方法
            mapEventCallBack(e) {
                this.map.closeAllPopup();
                //console.log("采集坐标：", e);
                this.map.offMapEvent("click", this.mapEventCallBack,"gatherName123");
                this.indexFlag = this.indexFlag + 1;
            ...
            //新区域新增点
            addNewPoint() {
                this.map.onMapEvent("click", this.addNewPointMapEventCallBack,"addNewPointName123");
            },
            //新增区域的点,并画出区域
            addNewPointMapEventCallBack(e) {
                ...
                this.map.offMapEvent("click", this.addNewPointMapEventCallBack,"addNewPointName123");
                this.indexFlag = this.indexFlag + 1;
        ...
        mounted() {
            ...
            this.markerJSON.option={};
            this.markerJSON.option.draggable = true;
        }
    }
</script>
