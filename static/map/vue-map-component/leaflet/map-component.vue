  ...
  module.exports = {
    ...
    methods: {
      ...
      initMap(mapJson) {
        ...
        tileLayerOption.maxZoom=mapConfig.maxZoom;
      ...
      addMovingMarker(movingMarkerJson) {
        ...
        for (var i = 0; i < movingMarkerJson.xys.length; i++) {
          if (movingMarkerJson.movingMarkerShowPopup) {
        ...
        console.log("point_popups：11",point_popups);
